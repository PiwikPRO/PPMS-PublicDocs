(function () {
    ...
    let style = document.querySelector('link[href$="/custom_1632479843898.css"]');
    ...
    document.querySelector('body > div.rst-versions.shift-up > div > div > dl:nth-child(1) > dd:nth-child(2) > a').innerText = 'latest (16.11)';
