...
api_definitions = {
    ...
    'platform_container_settings_authorized_api.json': 'web-api/platform/authorized_api/container_settings/src/settings.yaml',
    'platform_meta_sites_authorized_api.json': 'web-api/platform/authorized_api/meta_sites/public_v1.yaml',
    'platform_modules_authorized_api.json': 'web-api/platform/authorized_api/modules/public_v1.yaml',
    ...
    'tag_manager_authorized_api_triggers.json': 'web-api/tag_manager/authorized_api/src/triggers.yaml',
    'tag_manager_authorized_api_variables.json': 'web-api/tag_manager/authorized_api/src/variables.yaml',
